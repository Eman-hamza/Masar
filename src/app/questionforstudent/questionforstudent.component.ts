...
export class QuestionforstudentComponent implements OnInit {
  ...
  constructor(private route:ActivatedRoute, private admin:AdminService,private builder:FormBuilder, private scoreResponse:UserRoleService, private toast:ToastrService,private router:Router){
...
answers:StudentAnswerDTO={examid:0,
	studentId :'',
	qq:[]}
save(){
